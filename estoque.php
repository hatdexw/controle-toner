...
<div class="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
    ...
    <div class="mb-4">
        <input type="text" id="searchSuprimento" placeholder="Buscar suprimento por modelo ou tipo..." class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-3">
    </div>
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200" id="suprimentosTable">
