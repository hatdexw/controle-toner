      ...
      <div class="suprimento-card glass-card flex flex-col justify-between anim-hover-lift fade-in">
        ...
        <div class="bg-gray-50 dark:bg-gray-800/50 p-4 border-t border-gray-100 dark:border-white/5 flex items-center">
          <form action="/controle-toner/estoque" method="POST" class="flex items-center justify-between space-x-2 w-full">
            ...
            <div class="flex-grow"><label for="quantidade-<?= $suprimento['id'] ?>" class="sr-only">Quantidade</label><input type="number" name="quantidade" id="quantidade-<?= $suprimento['id'] ?>" value="<?= $suprimento['quantidade'] ?>" class="form-input !py-1 !px-2 text-center"></div>
            <div class="flex space-x-2">
              ...
              <button type="submit" name="delete_suprimento" class="danger-btn !px-3 !py-2 rounded-full" onclick="return confirm('Tem certeza que deseja excluir este item?');"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"/></svg></button>
            </div>
          </form>
        </div>
      </div>
