...
<div class="glass-card p-8 fade-in anim-hover-lift">
  ...
  <table class="table-base responsive-stack" id="impressorasTable">
      ...
      <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
        ...
        <tr class="table-row">
          <td class="table-cell font-medium" data-label="Código">
            <?= htmlspecialchars($impressora['codigo']) ?>
          </td>
          ...
          <td class="table-cell text-center flex flex-wrap gap-2 justify-center" data-label="Ações">
            ...
            <form action="/controle-toner/impressoras" method="POST" class="inline delete-impressora-form">
              <input type="hidden" name="csrf_token" value="<?= generate_csrf_token(); ?>">
              <input type="hidden" name="id" value="<?= $impressora['id'] ?>">
              <input type="hidden" name="delete_impressora" value="1">
              <button type="button" class="danger-btn !px-3 !py-2 text-xs delete-impressora" data-id="<?= $impressora['id'] ?>">
